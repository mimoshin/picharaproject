...
(function (factory) {
    ...
    //VER QUE PASA
    var defaultOpts = {
        //VARIABLE QUE CONTIENE LA PALETA DE COLORES A MOSTRAR 
        //IMPORTANTE
        // Callbacks
        beforeShow: noop,
        move: noop,
    ...
    function paletteTemplate (p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if(current) {
                ...
                html.push('<span title="' + formattedString + '" data-color="' + tiny.toHexString() + '" class="' + c + '"><span class="sp-thumb-inner" style="' + swatchStyle + ';"></span></span>');
            } else {
        ...
        return "<div class='sp-cf " + className + "que chucha'>" + html.join('') +"</div>";
    }
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            chooseButton.on("click.spectrum", function (e) {
                ...
                //$('.ButtonCell')[0].style.backgroundColor = selectionPalette[0];
            });
    ...
    */
    ...
    //SE EJECUTA CUANDO TERMINO LA ACCION DE ELEGIR COLOR AL CLIKEAR CON EL MOUSE
    //IMPORTANTE
    function stopPropagation(e) {
        e.stopPropagation();
        //console.log("PASA ALGO 2");
    }
