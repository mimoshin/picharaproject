...
SECRET_KEY = 'a&sb^)vplc)j&s080q#rn$zo@0fv55($n53c1mv1=6o##^az4i'
...
#AUTH MODEL
AUTH_USER_MODEL = 'pokerusers.user'
...
INSTALLED_APPS = [
    ...
    'profilemoves.apps.ProfilemovesConfig',
    'pokerusers.apps.PokerusersConfig',
]
